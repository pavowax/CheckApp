...
from pkg.SSTImap.utils.crawler import crawl, find_forms
from pkg.SSTImap.core.channel import Channel
from pkg.SSTImap.sstimap import args as sstimap_args
...
def scan_website(url):
    ...
    if channel.data.get('engine'):
        return channel # TODO: save vulnerabilities
    # else:
    #     for form in forms:
    ...
    #         result = check_template_injection(channel)
    #         if channel.data.get('engine'):
    #             return result, channel #: save vulnerabilities
    # return None, None