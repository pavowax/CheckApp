...
from pkg.SSTImap.utils import config
from pkg.SSTImap.utils.loggers import log
from urllib import parse
from pkg.SSTImap.core import checks
from pkg.SSTImap.core.channel import Channel
from pkg.SSTImap.core.clis import Shell, MultilineShell
from pkg.SSTImap.core.tcpserver import TcpServer
from pkg.SSTImap.core.tcpclient import TcpClient
import socket
...
# SSTImap commands
    ...
    def do_reload_modules(self, line):
        """Reload all modules"""
        from pkg.SSTImap.core.plugin import unload_plugins
        from pkg.SSTImap.sstimap import load_plugins
        unload_plugins()
        load_plugins()
        ...
        from pkg.SSTImap.core.data_type import unload_data_types
        from pkg.SSTImap.sstimap import load_data_types
        unload_data_types()
        load_data_types()
