...
import logging
import sys
import pkg.SSTImap.utils.config as utils_config
import os
...
if not os.path.isdir(utils_config.base_path):
    os.makedirs(utils_config.base_path)

"""Initialize the handler to dump log to files"""
log_path = os.path.join(utils_config.base_path, 'sstimap.log')
