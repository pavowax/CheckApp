...
def main(domain, threads, ports, silent, verbose, enable_bruteforce, engines):
    bruteforce_list = set()
    search_list = set()
...
def interactive():
    ...
    if args.no_color:
        no_color()
    res = main(domain, threads,ports, silent=False, verbose=verbose, enable_bruteforce=enable_bruteforce, engines=engines)
