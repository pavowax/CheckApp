...
from pkg.XSStrike.core.colors import end, red, green, yellow
from pkg.XSStrike.core.config import fuzzes, xsschecker
from pkg.XSStrike.core.requester import requester
from pkg.XSStrike.core.utils import replaceValue, counter
