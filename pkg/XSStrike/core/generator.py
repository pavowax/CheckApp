from pkg.XSStrike.core.config import xsschecker, badTags, fillings, eFillings, lFillings, jFillings, eventHandlers, tags, functions
from pkg.XSStrike.core.jsContexter import jsContexter
from pkg.XSStrike.core.utils import randomUpper as r, genGen, extractScripts
