...
from pkg.XSStrike.core.checker import checker
from pkg.XSStrike.core.colors import end, green, que
import pkg.XSStrike.core.config as config
from pkg.XSStrike.core.config import xsschecker, minEfficiency
from pkg.XSStrike.core.dom import dom
...
from pkg.XSStrike.core.utils import getUrl, getParams, getVar
from pkg.XSStrike.core.wafDetector import wafDetector
